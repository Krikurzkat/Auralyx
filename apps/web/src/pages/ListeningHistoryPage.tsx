  ...
  return (
    <div className="page-enter space-y-4 sm:space-y-6 pb-8">
      ...
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg sm:rounded-xl bg-gradient-to-br from-purple-500 to-pink-500">
          <RiListUnordered size={20} className="text-white" />
        </div>
        <div>
          <h1 className="text-xl sm:text-3xl font-bold">Listening History</h1>
