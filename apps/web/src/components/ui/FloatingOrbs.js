...
export default function FloatingOrbs({ variant = "default" }) {
    ...
    return (_jsx(ParticlesProvider, { init: particlesInit, children: _jsx(Particles, { id: "tsparticles-floating-orbs", className: `absolute inset-0 pointer-events-none mix-blend-screen ${isDriveMode ? "opacity-65" : "opacity-50"}`, options: options }, `floating-orbs-${variant}`) }));
}
