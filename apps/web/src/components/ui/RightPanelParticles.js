...
export default function RightPanelParticles({ variant, colors }) {
    const reactId = useId();
    ...
    return (_jsx(ParticlesProvider, { init: particlesInit, children: _jsx(Particles, { id: particleId, className: "absolute inset-0 pointer-events-none opacity-70 mix-blend-screen", options: options }) }));
}
