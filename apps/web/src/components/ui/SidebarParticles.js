...
export default function SidebarParticles({ variant, className = "absolute inset-0" }) {
    const reactId = useId();
    ...
    return (_jsx(ParticlesProvider, { init: particlesInit, children: _jsx(Particles, { id: particleId, className: `${className} pointer-events-none opacity-70 mix-blend-screen`, options: options }) }));
}
